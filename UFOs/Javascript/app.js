...
function filterTable() {
  ...
  var filterData = tableData;
    ...
    //   filters.forEach((filteredID) => {
    //   document.getElementById(filteredID).value;

    // })
    
    // filterData.forEach((filteredID) => {
    //   if (filteredID === tableData)
    //   filters = document.getElementById(filteredID).value;

    // })

    // if (data) {
    //   filters = filterData.filter(row => row.tableData === data);
    // };
